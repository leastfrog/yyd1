/*
  ...
  18 0,1,9,14,18 * * * https://raw.githubusercontent.com/leastfrog/yyd1/gua_wealth_island_help.js 财富大陆互助
...
!(async () => {
  ...
  let getShareNums = 0
  if (HelpAuthorFlag) {
    $.innerInviteList = await getAuthorShareCode('https://raw.githubusercontent.com/leastfrog/updateTeam/master/shareCodes/wealth_island_code_one.json');
    res2 = await getAuthorShareCode('https://raw.githubusercontent.com/leastfrog/updateTeam/master/shareCodes/wealth_island_code.json');
